-- =============================================================================
-- practicesテーブルにtitleカラムを追加（nullable）
-- competitionsテーブルのtitleをnullableに変更
-- competitionsテーブルのpool_typeをNOT NULLに変更
-- =============================================================================

-- 1. practicesテーブルにtitleカラムを追加（nullable）
ALTER TABLE "public"."practices"
ADD COLUMN "title" text;

COMMENT ON COLUMN "public"."practices"."title" IS '練習タイトル（NULLの場合は「練習」と表示）';

-- 2. competitionsテーブルのtitleをnullableに変更
-- 既存のNOT NULL制約を削除
...
-- 3. competitionsテーブルのpool_typeをNOT NULLに変更
-- 既存データでnullの場合は0に更新
...
-- 4. calendar_viewを更新して、titleがnullの場合はデフォルト値を表示
