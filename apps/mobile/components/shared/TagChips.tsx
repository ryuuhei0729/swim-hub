    ...
    <View style={styles.container}>
      {tags.length === 0 ? (
        ...
        <View style={styles.tagsWrap}>
          {tags.map((tag) => (
            <View key={tag.id} style={[styles.chip, { backgroundColor: tag.color }]}>
              <Pressable style={styles.chipContent} onPress={onPress} disabled={disabled}>
          ...
          <Pressable style={styles.addMoreButton} onPress={onPress} disabled={disabled}>
            <Feather name="plus" size={16} color="#6B7280" />
          </Pressable>
        </View>
      )}
