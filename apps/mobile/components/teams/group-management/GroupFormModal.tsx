      ...
      <Pressable style={styles.overlay} onPress={handleClose}>
        <Pressable style={styles.modalContent} onPress={(e) => e.stopPropagation()}>
            ...
            <View style={styles.formGroup}>
              ...
              {existingCategories.length > 0 && (
                <View style={styles.modeToggle}>
                  ...
                  >
                    <Text style={[styles.modeButtonText, categoryMode === 'existing' && styles.modeButtonTextActive]}>
                      既存から選択
                    </Text>
                  </Pressable>
                  <Pressable
              ...
              {categoryMode === 'existing' && existingCategories.length > 0 ? (
                <View style={styles.categoryPills}>
                  ...
                  {existingCategories.map((cat) => (
                    ...
                    >
                      <Text style={[styles.categoryPillText, selectedCategory === cat && styles.categoryPillTextSelected]}>
                        {cat}
                      </Text>
                    </Pressable>
                  ))}
          ...
          <View style={styles.footer}>
            ...
            <Pressable
              style={[styles.button, styles.submitButton, (!isValid || saving) && styles.submitButtonDisabled]}
