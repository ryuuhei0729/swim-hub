        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-lg">
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">マイルストーンの振り返り</h3>
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600 mb-2">以下のマイルストーンが期限を迎えました</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* 次のアクション */}
              <div>
                <p className="text-sm font-medium text-gray-700 mb-2">次のアクション</p>
                <div className="space-y-2">
                  <Button
                    type="button"
                    variant="outline"
