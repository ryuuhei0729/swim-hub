  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <div role="radiogroup" aria-label="マイルストーンタイプ選択" className="flex gap-3">
          {[
            {
              value: "time" as const,
              label: "タイム目標",
              description:
                "練習及びタイムトライアルで出したいタイムをマイルストーンに置く。前半のタイムを一旦目標に置くのもおすすめ",
            },
            {
              value: "reps_time" as const,
              label: "練習平均タイム目標",
              description:
                "本数×セット数の平均タイムをマイルストーンに置く。100m以上の種目におすすめ",
            },
            {
              value: "set" as const,
              label: "サークルイン目標",
              description:
                "＠サークル で回れる本数、セット数をマイルストーンに置く。200m以上の種目におすすめ",
            },
          ].map((option) => (
        ...
        {selectedTemplate && (
          <p className="text-xs text-gray-500 mt-1">テンプレート適用中: タイプは変更できません</p>
        )}
      </div>
