            ...
            <div className="space-y-4 sm:space-y-6 animate-fade-in text-center lg:text-left order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <a
                  ...
                  className="inline-flex items-center justify-center px-4 sm:px-5 py-2.5 sm:py-3 bg-black text-white rounded-xl border border-white/15 shadow-md hover:bg-zinc-800 active:scale-[0.98] transition-all duration-150"
                >
                  <svg
                    className="w-7 h-7 sm:w-6 sm:h-6 mr-2.5"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    aria-hidden="true"
                  >
                  ...
                  <div className="text-left leading-tight">
                    <div className="text-[11px] sm:text-[10px] tracking-wide">Download on the</div>
                    <div className="text-xl sm:text-lg font-semibold -mt-0.5">App Store</div>
                  </div>
                </a>
                <button
                  disabled
                ...
                >
                  <svg
                    className="w-7 h-7 sm:w-6 sm:h-6 mr-2"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-3">
              <span className="inline-flex items-center justify-center px-4 py-1 rounded-full bg-blue-600 text-white text-lg font-bold shrink-0">
                機能 1
              </span>
              練習記録・タイムを管理
            </h2>
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
            <a
              ...
              rel="noopener noreferrer"
              aria-label="App Store からダウンロード"
              className="inline-flex items-center justify-center px-6 py-3 bg-black text-white rounded-xl border border-white/15 shadow-md hover:bg-zinc-800 active:scale-[0.98] transition-all duration-150"
            >
              <svg className="w-7 h-7 mr-2.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
              </svg>
              <div className="text-left leading-tight">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">水泳をもっと便利にするツール群</p>
          </div>
