    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">シェアカード デモ</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="flex justify-center">
            <div className="rounded-2xl shadow-2xl overflow-hidden">
              {activeTab === "competition" ? (
                <CompetitionShareCard ref={competitionCardRef} data={sampleCompetitionData} />
              ) : (
                <PracticeShareCard ref={practiceCardRef} data={samplePracticeData} />
              )}
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 rounded-xl p-6">
              <h3 className="text-sm font-semibold text-blue-900 mb-2">Instagram Story向け仕様</h3>
