...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "legal.tokushoho" });
  return {
    title: t("metaTitle"),
    description: t("metaDesc"),
    alternates: { canonical: `${SITE_URL}/${locale}/tokushoho` },
  };
}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500">
            {t("lastUpdated")}: {formatDate(new Date("2026-03-14"), "long")}
          </p>
        </div>
