    ...
    <div className="min-h-screen bg-blue-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">{t("headerDescription")}</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-10">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                SwimHub は、水泳選手・コーチ・マネージャーのための総合記録管理サービスです。
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                ...
                練習ノートに手書きでタイムを記録し、大会の結果は紙媒体に書き込む。
              ...
              <p>
                ...
                特にコーチ業を営む方々から「チーム全員のタイムを効率的に管理したい」「チーム卒業後も記録はその選手の財産として残っていてほしい」という要望をいただき、
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    自動的に判定・更新されます。自己ベストを更新した際にはベストタイムのバッジが表示され、
                    モチベーションの向上につながります。
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    チーム内のベストタイム一覧表や、大会ごとの出場メンバー管理など、
          ...
          <section>
            ...
            <div className="bg-blue-50 rounded-lg p-6 space-y-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                水泳を始めたのは小学校4年生の時でした。地元のスイミングクラブに通い始め、
                2年ほどで4泳法を泳げるようになりました。
                しかしこの頃は親に「行かされている」という感覚で、
                週一ゆるゆるスイマーとして水泳と向き合っていました。（50Fr 32~3秒）
              </p>

              <p className="text-gray-700 leading-relaxed">
                中学・高校では学校の水泳部に所属し、ベストタイムを目指して
                練習に励みました。決して強豪校ではありませんでしたが、
                自分の青春を捧げたと言い切れるほど打ち込みました。（50Fr 24-82）
              </p>

              <p className="text-gray-700 leading-relaxed">
                大学ではフィンスイミングをはじめ、競泳は趣味程度に続けようと
                気楽に打ち込みましたが、この気楽さが自分にはハマり、
                練習量は激減しましたがかなり成長しました。（50Fr 23-80）
              </p>

              <h3 className="font-medium text-gray-900 pt-2">コーチング・指導経験</h3>
              <p className="text-gray-700 leading-relaxed">
                選手としての活動と並行して、大学時代からジュニア選手の指導にも携わってきました。
                母校の水泳部で中高生の指導を担当し、泳法指導だけでなく、
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 rounded-lg p-5">
                ...
                <p className="text-gray-700 leading-relaxed">
                  水泳選手特化型の動画編集アプリです。
                  大会や練習で撮った動画にストップウォッチを重ねることができ、
                  途中のラップタイム（25m・50mなどの数字だけでなく、12.5mや15mなども可能）を
                  正確に記録・可視化することが可能です。
                </p>
              </div>
              <div className="border border-gray-200 rounded-lg p-5">
                ...
                <p className="text-gray-700 leading-relaxed">
                  AIを活用した練習タイムの自動解析ツールです。
                  水泳記録をDX化する上で最も高い障壁は「プールサイドに電子機器を持ち込めない」ことでした。
                  練習ではどうしてもホワイトボードや紙媒体での記録になってしまうため、
                  せめてもの抵抗として「アナログの練習タイムをデジタルに読み起こす」というツールを作りました。
                  ぜひ使ってみてください。
                </p>
              </div>
            </div>
