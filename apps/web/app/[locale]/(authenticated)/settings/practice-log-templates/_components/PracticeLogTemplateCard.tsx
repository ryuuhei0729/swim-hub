...
export function PracticeLogTemplateCard({
  ...
  const t = useTranslations("practiceLogTemplates.card");
  ...
  return (
    <>
      <div className="relative bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center gap-2">
            <button
              ...
              aria-label={template.is_favorite ? t("menuRemoveFavorite") : t("menuAddFavorite")}
            >
        ...
        {template.use_count > 0 && (
          <div className="mt-3 pt-2 border-t border-gray-100 text-xs text-gray-400">
            {t("useCount", { count: template.use_count })}
          </div>
        )}
      </div>
      ...
      <ConfirmDialog
        ...
        message={t("deleteConfirm.message", { name: template.name })}
        variant="danger"
