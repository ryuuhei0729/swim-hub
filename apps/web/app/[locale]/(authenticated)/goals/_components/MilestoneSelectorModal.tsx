        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-md">
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">{t("milestoneSelector.title")}</h3>
            ...
            {isLoading ? (
              <div className="text-center py-8">
                <p className="text-gray-500">{t("milestoneSelector.loading")}</p>
              </div>
            ) : milestones.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-gray-500">{t("milestoneSelector.empty")}</p>
              </div>
            ) : (
