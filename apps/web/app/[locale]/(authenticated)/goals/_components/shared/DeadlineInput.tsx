...
export default function DeadlineInput({
  ...
  const resolvedLabel = label ?? t("deadlineInput.defaultLabel");
    ...
    <div>
      <div className="flex gap-2 items-end">
        <div className="flex-1">
          <DatePicker label={resolvedLabel} value={value} onChange={onChange} popupPosition="top" />
        </div>
        <Button
          type="button"
          variant="outline"
