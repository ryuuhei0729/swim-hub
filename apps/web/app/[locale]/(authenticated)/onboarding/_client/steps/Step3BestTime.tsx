      ...
      <div className="flex gap-3">
        ...
        {hasEntries ? (
          <Button
            ...
            className="flex-1"
          >
            {saving ? t("saving") : completing ? t("completing") : t("saveButton")}
          </Button>
        ) : (
          <Button
            type="button"
            ...
            className="flex-1"
          >
            {completing ? t("completing") : t("skipButton")}
          </Button>
        )}
      </div>
    </div>
          ...
          <div className="relative">
            ...
            <div className="absolute right-1 top-1/2 -translate-y-1/2 group/hint">
              ...
              <div className="hidden group-hover/hint:sm:block absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 w-48 p-2 bg-gray-800 text-white text-xs rounded shadow-lg z-10 leading-relaxed">
                <p className="font-semibold mb-1">{t("inputHintTitle")}</p>
                <p>{t("inputHintBody")}</p>
              </div>
              {/* スマホ: タップトグル、中央寄せ */}
              {showTimeHint && (
