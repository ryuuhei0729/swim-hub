...
export default function DashboardStats() {
  ...
  const stats = [
    {
      title: t("stats.monthlyPractice.title"),
      value: practiceCount,
      icon: CalendarDaysIcon,
      color: "bg-blue-500",
      unit: t("stats.monthlyPractice.unit"),
    },
    {
      title: t("stats.competitionRecord.title"),
      value: recordCount,
      icon: TrophyIcon,
      color: "bg-green-500",
      unit: t("stats.competitionRecord.unit"),
    },
    {
      title: t("stats.practiceDays.title"),
      value: practiceCount,
      icon: ChartBarIcon,
      color: "bg-purple-500",
      unit: t("stats.practiceDays.unit"),
    },
  ];
