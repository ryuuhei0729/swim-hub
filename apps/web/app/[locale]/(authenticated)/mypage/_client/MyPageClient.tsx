 ...
 */
export default function MyPageClient({ initialProfile, initialBestTimes }: MyPageClientProps) {
    ...
    async (updatedProfile: Partial<UserProfile>) => {
      ...
      try {
        ...
        if (updatedProfile.avatar_url !== undefined)
          dbUpdate.profile_image_path = updatedProfile.avatar_url;
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex flex-row items-center justify-between pb-2 mb-4 border-b border-gray-200">
            <h2 className="text-base sm:text-xl font-semibold text-gray-900">{t("profile.title")}</h2>
            <button
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex flex-row items-center justify-between mb-4">
            <div className="flex items-center space-x-1.5 sm:space-x-2">
              ...
              <h2 className="text-base sm:text-2xl font-semibold text-gray-900">{t("bestTime.title")}</h2>
            </div>
            <Link
              href="/bulk-besttime"
