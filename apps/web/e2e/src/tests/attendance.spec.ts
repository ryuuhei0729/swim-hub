...
test.describe("出席管理のテスト", () => {
  ...
  test("TC-ATTEND-001: 出席登録", async ({ page }) => {
    ...
    expect(
      buttonClasses?.includes("green") || buttonClasses?.includes("border-green"),
    ).toBeTruthy();
  ...
  test("TC-ATTEND-002: 出席編集", async ({ page }) => {
    ...
    const statusButtons = page.locator(
      'button:has-text("出席"), button:has-text("欠席"), button:has-text("その他")',
    );
    ...
    const isCurrentlyPresent =
      presentClasses.includes("green") || presentClasses.includes("border-green");
  ...
  test("TC-ATTEND-004: 出席フィルタリング", async ({ page }) => {
    ...
    expect(
      currentMonthClasses.includes("blue") || currentMonthClasses.includes("border-blue"),
    ).toBeTruthy();
    ...
    expect(
      newNextMonthClasses.includes("blue") || newNextMonthClasses.includes("border-blue"),
    ).toBeTruthy();
    ...
    expect(
      finalCurrentMonthClasses.includes("blue") || finalCurrentMonthClasses.includes("border-blue"),
    ).toBeTruthy();
  });
