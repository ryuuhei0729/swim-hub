  ...
  return (
    <>
      <div className="relative" ref={dropdownRef}>
        ...
        {/* ドロップダウンメニュー */}
        {isOpen && (
          <div className="absolute z-[70] w-full bottom-full mb-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-y-auto" data-testid="tag-dropdown">
            {/* タグ一覧 */}
            <div className="py-1">
