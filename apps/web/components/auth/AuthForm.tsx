...
export const AuthForm: React.FC<AuthFormProps> = ({ mode = "signin", onSuccess, showOAuth = true }) => {
          ...
          {formMode === "signup" && (
            <>
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 mt-1 block w-full rounded-lg border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-3 px-3 transition duration-150 ease-in-out"
                    placeholder="山田太郎"
                  />
                </div>
              </div>
              <div>
                ...
                <div
                  className="mt-1 grid grid-cols-2 rounded-lg border border-gray-300 overflow-hidden"
                  role="group"
                  aria-label={tFields("gender")}
                >
                  <button
                    type="button"
                    onClick={() => setGender(0)}
                    ...
                    className={`py-3 px-3 text-sm transition-colors ${
                      gender === 0 ? "bg-blue-600 text-white" : "bg-white text-gray-700 hover:bg-gray-50"
                    }`}
                  >
                    {tFields("genderMale")}
                  </button>
                  <button
                    ...
                    className={`py-3 px-3 text-sm transition-colors border-l border-gray-300 ${
                      gender === 1 ? "bg-blue-600 text-white" : "bg-white text-gray-700 hover:bg-gray-50"
                    }`}
                  >
                    {tFields("genderFemale")}
                  </button>
                </div>
              </div>
              <div>
