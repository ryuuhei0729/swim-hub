...
export const OAuthButtons: React.FC<OAuthButtonsProps> = ({
  ...
  const googleLabel = context === "signup" ? t("googleSignup") : t("googleSignin");
  const appleLabel = context === "signup" ? t("appleSignup") : t("appleSignin");
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-xl text-sm font-semibold text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 disabled:cursor-not-allowed transition duration-150 ease-in-out shadow-sm"
      >
