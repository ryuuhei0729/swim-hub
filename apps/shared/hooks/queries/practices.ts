...
export function usePracticesQuery(
  ...
  const api = useMemo(() => providedApi ?? new PracticeAPI(supabase), [supabase, providedApi]);
...
export function usePracticeByIdQuery(
  ...
  const { enableRealtime = true, initialData, api: providedApi } = options;
...
export function useCreatePracticeMutation(
  supabase: SupabaseClient,
  api?: PracticeAPI,
): UseMutationResult<Practice, Error, Omit<PracticeInsert, "user_id">> {
  const queryClient = useQueryClient();
      ...
      try {
        ...
        if (user) {
          ...
          if (profile?.google_calendar_enabled && profile?.google_calendar_sync_practices) {
            ...
            const syncResult = await syncPracticeToGoogleCalendar(
              created,
              "create",
              undefined,
...
export function useUpdatePracticeMutation(
  supabase: SupabaseClient,
  api?: PracticeAPI,
): UseMutationResult<Practice, Error, { id: string; updates: PracticeUpdate }> {
  const queryClient = useQueryClient();
  const practiceApi = useMemo(() => api ?? new PracticeAPI(supabase), [supabase, api]);
        ...
        try {
          ...
          if (user) {
            ...
            if (
              ...
              profile?.google_calendar_sync_practices &&
              googleEventId
            ) {
              const { syncPracticeToGoogleCalendar } = await import("../../api/google-calendar");
              // React Native用にアクセストークンを取得
              ...
              await syncPracticeToGoogleCalendar(
                practiceData,
                "delete",
                googleEventId,
                session?.access_token,
 ...
 * 練習ログ削除ミューテーション
 */
export function useDeletePracticeLogMutation(
  supabase: SupabaseClient,
  api?: PracticeAPI,
): UseMutationResult<void, Error, string> {
  const queryClient = useQueryClient();
 ...
 * 練習タイム作成ミューテーション
 */
export function useCreatePracticeTimeMutation(
  supabase: SupabaseClient,
  api?: PracticeAPI,
 ...
 * 練習タイム削除ミューテーション
 */
export function useDeletePracticeTimeMutation(
  supabase: SupabaseClient,
  api?: PracticeAPI,
): UseMutationResult<void, Error, string> {
  const queryClient = useQueryClient();
 ...
 * 練習タグ一覧取得クエリ
 */
export function usePracticeTagsQuery(
  supabase: SupabaseClient,
  api?: PracticeAPI,
): UseQueryResult<PracticeTag[], Error> {
  const practiceApi = useMemo(() => api ?? new PracticeAPI(supabase), [supabase, api]);
 ...
 * 練習タグ作成ミューテーション
 */
export function useCreatePracticeTagMutation(
  supabase: SupabaseClient,
  api?: PracticeAPI,
): UseMutationResult<PracticeTag, Error, { name: string; color: string }> {
  const queryClient = useQueryClient();
  const practiceApi = useMemo(() => api ?? new PracticeAPI(supabase), [supabase, api]);
 ...
 * 練習タグ更新ミューテーション
 */
export function useUpdatePracticeTagMutation(
  supabase: SupabaseClient,
  api?: PracticeAPI,
): UseMutationResult<void, Error, { id: string; name: string; color: string }> {
  const queryClient = useQueryClient();
  const practiceApi = useMemo(() => api ?? new PracticeAPI(supabase), [supabase, api]);
 ...
 * 練習タグ削除ミューテーション
 */
export function useDeletePracticeTagMutation(
  supabase: SupabaseClient,
  api?: PracticeAPI,
): UseMutationResult<void, Error, string> {
  const queryClient = useQueryClient();
