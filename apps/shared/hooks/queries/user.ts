  ...
  const profileQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        .from('users')
        .select('id, name, gender, birthday, profile_image_path, bio, google_calendar_enabled, google_calendar_sync_practices, google_calendar_sync_competitions, ios_calendar_enabled, ios_calendar_sync_practices, ios_calendar_sync_competitions, created_at, updated_at')
        .eq('id', targetUserId)
        .single()
