...
describe("useCreateTeamMutation", () => {
  ...
  it("チームを作成できる", async () => {
    ...
    const { result } = renderHook(() => useCreateTeamMutation(mockClient, mockCoreApi), {
      wrapper: createWrapper(),
    });
...
describe("useUpdateTeamMutation", () => {
  ...
  it("チームを更新できる", async () => {
    ...
    const { result } = renderHook(() => useUpdateTeamMutation(mockClient, mockCoreApi), {
      wrapper: createWrapper(),
    });
...
describe("useDeleteTeamMutation", () => {
  ...
  it("チームを削除できる", async () => {
    ...
    const { result } = renderHook(() => useDeleteTeamMutation(mockClient, mockCoreApi), {
      wrapper: createWrapper(),
    });
