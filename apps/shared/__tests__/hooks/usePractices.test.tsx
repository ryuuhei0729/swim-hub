...
describe("usePracticesQuery", () => {
  ...
  it("練習記録一覧を取得できる", async () => {
    ...
    const { result } = renderHook(() => usePracticesQuery(mockClient, { api: mockApi }), {
...
describe("useCreatePracticeMutation", () => {
  ...
  it("練習記録を作成できる", async () => {
    ...
    const { result } = renderHook(() => useCreatePracticeMutation(mockClient, mockApi), {
      wrapper: createWrapper(),
    });
...
describe("useUpdatePracticeMutation", () => {
  ...
  it("練習記録を更新できる", async () => {
    ...
    const { result } = renderHook(() => useUpdatePracticeMutation(mockClient, mockApi), {
      wrapper: createWrapper(),
    });
...
describe("useDeletePracticeMutation", () => {
  ...
  it("練習記録を削除できる", async () => {
    ...
    const { result } = renderHook(() => useDeletePracticeMutation(mockClient, mockApi), {
      wrapper: createWrapper(),
    });
