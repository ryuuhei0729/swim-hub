...
describe("useRecordsQuery", () => {
  ...
  it("大会記録一覧を取得できる", async () => {
    ...
    const { result } = renderHook(() => useRecordsQuery(mockClient, { api: mockApi }), {
...
describe("useCreateRecordMutation", () => {
  ...
  it("大会記録を作成できる", async () => {
    ...
    const { result } = renderHook(() => useCreateRecordMutation(mockClient, mockApi), {
      wrapper: createWrapper(),
    });
...
describe("useUpdateRecordMutation", () => {
  ...
  it("大会記録を更新できる", async () => {
    ...
    const { result } = renderHook(() => useUpdateRecordMutation(mockClient, mockApi), {
      wrapper: createWrapper(),
    });
...
describe("useDeleteRecordMutation", () => {
  ...
  it("大会記録を削除できる", async () => {
    ...
    const { result } = renderHook(() => useDeleteRecordMutation(mockClient, mockApi), {
      wrapper: createWrapper(),
    });
