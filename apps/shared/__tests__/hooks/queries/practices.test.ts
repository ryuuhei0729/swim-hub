...
describe("Practice Query Hooks", () => {
  ...
  describe("usePracticesQuery", () => {
    it("練習一覧を取得できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        usePracticesQuery(mockSupabase, {
  ...
  describe("usePracticesCountQuery", () => {
    it("練習件数を取得できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        usePracticesCountQuery(mockSupabase, {
          api: mockApi as unknown as PracticeAPI,
        }),
      );
  ...
  describe("usePracticeByIdQuery", () => {
    it("IDで練習を取得できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        usePracticeByIdQuery(mockSupabase, "practice-123", {
          enableRealtime: false,
          api: mockApi as unknown as PracticeAPI,
        }),
      );
    ...
    it("存在しない練習の場合はnullを返す", async () => {
      ...
      const { result } = renderQueryHook(() =>
        usePracticeByIdQuery(mockSupabase, "non-existent", {
          enableRealtime: false,
          api: mockApi as unknown as PracticeAPI,
        }),
      );
  ...
  describe("useCreatePracticeMutation", () => {
    it("練習を作成できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useCreatePracticeMutation(mockSupabase, mockApi as unknown as PracticeAPI),
      );
  ...
  describe("useUpdatePracticeMutation", () => {
    it("練習を更新できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useUpdatePracticeMutation(mockSupabase, mockApi as unknown as PracticeAPI),
      );
  ...
  describe("usePracticeTagsQuery", () => {
    it("練習タグ一覧を取得できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        usePracticeTagsQuery(mockSupabase, mockApi as unknown as PracticeAPI),
      );
