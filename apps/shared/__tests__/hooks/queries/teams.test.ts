...
describe("Team Query Hooks", () => {
  ...
  describe("useCreateTeamMutation", () => {
    it("チームを作成できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useCreateTeamMutation(mockSupabase, mockCoreApi as unknown as TeamCoreAPI),
      );
  ...
  describe("useUpdateTeamMutation", () => {
    it("チームを更新できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useUpdateTeamMutation(mockSupabase, mockCoreApi as unknown as TeamCoreAPI),
      );
  ...
  describe("useDeleteTeamMutation", () => {
    it("チームを削除できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useDeleteTeamMutation(mockSupabase, mockCoreApi as unknown as TeamCoreAPI),
      );
  ...
  describe("useJoinTeamMutation", () => {
    it("招待コードでチームに参加できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useJoinTeamMutation(mockSupabase, mockMembersApi as unknown as TeamMembersAPI),
      );
    ...
    it("無効な招待コードでエラーになる", async () => {
      ...
      await act(async () => {
        await expect(result.current.mutateAsync("INVALID")).rejects.toThrow("Invalid invite code");
      });
    });
  });
  ...
  describe("useLeaveTeamMutation", () => {
    it("チームから退出できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useLeaveTeamMutation(mockSupabase, mockMembersApi as unknown as TeamMembersAPI),
      );
  ...
  describe("useUpdateMemberRoleMutation", () => {
    it("メンバーのロールを更新できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useUpdateMemberRoleMutation(mockSupabase, mockMembersApi as unknown as TeamMembersAPI),
      );
  ...
  describe("useRemoveMemberMutation", () => {
    it("メンバーを削除できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useRemoveMemberMutation(mockSupabase, mockMembersApi as unknown as TeamMembersAPI),
      );
