...
describe("Record Query Hooks", () => {
  ...
  describe("useRecordsCountQuery", () => {
    it("記録件数を取得できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useRecordsCountQuery(mockSupabase, {
          api: mockApi as unknown as RecordAPI,
        }),
      );
  ...
  describe("useBestTimesQuery", () => {
    it("ベストタイムを取得できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useBestTimesQuery(mockSupabase, {
          api: mockApi as unknown as RecordAPI,
        }),
      );
  ...
  describe("useCreateRecordMutation", () => {
    it("記録を作成できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useCreateRecordMutation(mockSupabase, mockApi as unknown as RecordAPI),
      );
  ...
  describe("useUpdateRecordMutation", () => {
    it("記録を更新できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useUpdateRecordMutation(mockSupabase, mockApi as unknown as RecordAPI),
      );
  ...
  describe("useDeleteRecordMutation", () => {
    it("記録を削除できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useDeleteRecordMutation(mockSupabase, mockApi as unknown as RecordAPI),
      );
  ...
  describe("useCreateSplitTimesMutation", () => {
    it("スプリットタイムを作成できる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useCreateSplitTimesMutation(mockSupabase, mockApi as unknown as RecordAPI),
      );
  ...
  describe("useReplaceSplitTimesMutation", () => {
    it("スプリットタイムを置き換えできる", async () => {
      ...
      const { result } = renderQueryHook(() =>
        useReplaceSplitTimesMutation(mockSupabase, mockApi as unknown as RecordAPI),
      );
