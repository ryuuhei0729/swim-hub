...
| 優先順位 | セレクタ種類 | 使用可否 | 理由 |
|---------|------------|---------|------|
| ✅ 1 | data-testid | **最優先** | 最も安定、保守性が高い |
| ✅ 2 | セマンティック（getByRole等） | **推奨** | アクセシビリティ向上 |
| ✅ 3 | label | **推奨** | フォーム要素に有効 |
| ⚠️ 4 | CSSセレクタ + :has-text() | **代替** | data-testidがない場合のみ |
| ⚠️ 5 | 属性セレクタ（name, type） | **代替** | data-testidがない場合のみ |
...
page.getByTestId('practice-mark')
